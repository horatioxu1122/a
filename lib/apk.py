...
GB=f'plugins{{id("com.android.application");id("org.jetbrains.kotlin.android")}}\nandroid{{namespace="{P}";compileSdk=34;defaultConfig{{applicationId="{P}";minSdk=24;targetSdk=34;versionCode=202;ndk{{abiFilters+="arm64-v8a"}};externalNativeBuild{{cmake{{arguments+="-DANDROID_STL=none"}}}}}}\nexternalNativeBuild{{cmake{{path=file("src/main/cpp/CMakeLists.txt")}}}}\ncompileOptions{{sourceCompatibility=JavaVersion.VERSION_11;targetCompatibility=JavaVersion.VERSION_11}}\nkotlinOptions{{jvmTarget="11"}}}}\n'
...
def run():
    ...
    if proj:
        ...
        w(D+"/app/src/main/cpp/native.c",NC);w(D+"/app/src/main/cpp/CMakeLists.txt",CML)
